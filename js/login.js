...
        // MEJORA A11Y: Se añade aria-hidden="true"
...
    btnIngresar.innerHTML = '<i class="fas fa-spinner fa-spin me-2" aria-hidden="true"></i>Verificando...';
    
...
        body: JSON.stringify({
            // CORRECCIÓN: Usar 'usuario' en lugar de 'email' para coherencia del frontend/API
            usuario: usuario,      
...
            // MEJORA A11Y: Se añade aria-hidden="true"
            btnIngresar.innerHTML = '<i class="fas fa-sign-in-alt me-2" aria-hidden="true"></i>Ingresar';
            
